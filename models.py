...
class Report(db.Model):
    ...
    # Field for notes associated with the report (i.e. initial description).
    ...
    # Relationship for threaded (comment) notes.
...
# ---------------------------------------------------------------------
# New Note Model for Attached Notes / Remarks with Thread Replies
# ---------------------------------------------------------------------
class Note(db.Model):
    __tablename__ = 'notes'
    ...
    # Link this note to a report and its author.
    ...
    # For threaded replies; if a note is a reply, its parent_id will be set.
